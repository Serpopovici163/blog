...
- Light green --> Volume + arrow keys of left side custer
- Red --> Common of left side cluster
- Green --> Arrow keys of right side cluster
- Purple --> Other keys of right side cluster
